...
use Illuminate\Support\Facades\Hash; // thu vien hash
use Illuminate\Support\Facades\Auth; //chung thuc dang nhap
...
class WebsiteController extends Controller
{
    ...
    public function forgot_password_submit(Request $request)
    {
        ...
        $message = 'Please click on the the following link: <br><a href="' . $reset_link . '">Click here</a>';
